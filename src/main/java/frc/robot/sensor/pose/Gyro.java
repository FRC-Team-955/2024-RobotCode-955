...
//                }
    ...
    public static Rotation2d getPitch() { return Rotation2d.fromDegrees(pigeon.getPitch().getValue()); }
    public static Rotation2d getRoll() { return Rotation2d.fromDegrees(pigeon.getRoll().getValue()); }
}
